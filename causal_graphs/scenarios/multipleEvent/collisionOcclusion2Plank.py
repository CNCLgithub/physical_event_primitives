...
DATA = {
    'scene': [
        ...
        },
        {
            ...
            'xform': {
                'value': [-.5, TOP_TRACK_LWHT[1]/2+.01, .37, 0, 0, 40],
                'range': [
...

        {
            ...
            'xform': {
                'value': [
                    BOTTOM_TRACK_LWHT[0] + HIGH_PLANK_LWH[2] - .6,
                    0,

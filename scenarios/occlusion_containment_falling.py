...
DATA = {
    'scene': [
        ...
        },
        {
            ...
            'xform': {
                'value': [.1, .05, OCCLUDER_LWH[0]/2-.002, 0, 0, 90],
            }
        },
        movingObject,
        {
            ...
            'xform': {
                'value': [-TOP_TRACK_LWHT[0]/2 - GOBLET_HEIGHT, .03, 0, 0, 0, 88],
            }
        },
    ],
}

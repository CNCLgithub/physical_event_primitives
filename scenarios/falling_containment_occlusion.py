...
OCCLUDER_LWH = (random.uniform(.08, .2), 0.001, 0.33)  # [m]
    ...
    'scene': [
        ...
        },
        {
            ...
            'xform': {
                ...
                'value': [-.1, TOP_TRACK_LWHT[1]/2+.01, .3+(random.uniform(-.1,.1)), 0, 0, 10+(random.uniform(-10,10))]
            }
        },
{
            'name': "goblet",
            ...
            'xform': {
                'value': [GOBLET_HEIGHT*3+.05, .05, GOBLET_R1-.002, 0, 10, -90],
            }
        },    
        movingObject,
        {

    ...
    'scene': [
        ...
        },
        {
            ...
            'xform': {
                ...
                'value': [-.1, TOP_TRACK_LWHT[1]/2+.01, .40+(random.uniform(-.1,.1)), 0, 0, 10+(random.uniform(-10,10))]
            }
        },
        {
            'name': "track2",
            ...
            'xform': {
                # Randomness: track height and angle 
                # 10+(random.uniform(-10,10))
                'value': [.2, TOP_TRACK_LWHT[1]/2+.01, .3, 0, 0, 0]
            }
        },
        {
            'name': "track3",
            ...
            'xform': {
                # Randomness: track height and angle 
                # 10+(random.uniform(-10,10))
                'value': [.4, TOP_TRACK_LWHT[1]/2+.01, .15, 0, 0, 0]
            }
        },
        movingObject
    ]

...
BALL_RADIUS = random.uniform(0.02, 0.032)   # [m]
BALL_MASS = BALL_RADIUS**3 * math.pi * (4/3) * DENSITY  # [kg]
BALL_RESTITUTION = 0.8

TOP_TRACK_LWHT = (0.6, 0.1, 0.01, 0.006)  # [m]
BOTTOM_TRACK_LWHT = (0.3, 0.1, 0.01, 0.006)  # [m]
...
if random.random() < 0:
    ...
    movingObject = {
        ...
        'args': {
            'radius': BALL_RADIUS,
            'force': (random.uniform(.007, .009),0,0),
            'b_mass': BALL_MASS,
    ...
    'scene': [
        ...
        },
        {
            ...
            'xform': {
                ...
                'value': [-.3, TOP_TRACK_LWHT[1]/2+.01, .40+(random.uniform(-.05,.01)), 0, 0, 0]
            }
        },
        {
            'name': "track2",
            ...
            'xform': {
                # Randomness: track height and angle 
                # 10+(random.uniform(-10,10))
                'value': [.2, TOP_TRACK_LWHT[1]/2+.01, .20, 0, 0, 0]
            }
        },
        movingObject
    ]

...
TOP_TRACK_LWHT = (0.5, 0.05, 0.012, 0.006)  # [m]
...
if random.random() < 0:
    ...
    movingObject = {
        ...
        'args': {
            'radius': BALL_RADIUS,
            'force': (random.uniform(.008, .012),0,0),
            'b_mass': BALL_MASS,
        ...
        'xform': {
            'value': [-TOP_TRACK_LWHT[0]/2+.01, 0, BALL_RADIUS+.003,
                      0, 0, 0]
        }
    }
if random.random() < 1:
    ...
    'scene': [
        ...
        },
        {
            ...
            'xform': {
                ...
                'value': [-.2, TOP_TRACK_LWHT[1]/2+.01, .3+(random.uniform(0,.1)), 0, 0, 0]
            }
        },
        movingObject,
        movingObject2

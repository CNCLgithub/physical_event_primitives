...
DATA = {
    'scene': [
        ...
        },
        {
            ...
            'xform': {
                'value': [TOP_TRACK_LWHT[0]/2-OCCLUDER_LWH[2]/2, .05, OCCLUDER_LWH[0]/2-.002, 0, 0, 90],
            }
        },
    ],
}

    ...
    'scene': [
        ...
        },
        {
            ...
            'xform': {
                ...
                'value': [-.1, TOP_TRACK_LWHT[1]/2+.01, .35+(random.uniform(0,.1)), 0, 0, 10+(random.uniform(-10,10))]
            }
        },
        {
            'name': "track2",
            ...
            'xform': {
                # Randomness: track height and angle 
                # 10+(random.uniform(-10,10))
                'value': [.2, TOP_TRACK_LWHT[1]/2+.01, .10+(random.uniform(0,.1)), 0, 0, 0]
            }
        },
        {
            'name': "occluder",
            ...
            'xform': {
                'value': [.10, .05, OCCLUDER_LWH[0]/2-.002, 0, 0, 90],
            }
        }, 
        movingObject,
    ]

...
TOP_TRACK_LWHT = (0.5, 0.06, 0.01, 0.006)  # [m]
...
if random.random() < 0:
    ...
    movingObject = {
        ...
        'args': {
            'radius': BALL_RADIUS,
            'force': (random.uniform(.005, .008),0,0),
            'b_mass': BALL_MASS,
    ...
    'scene': [
        ...
        },
        {
            ...
            'xform': {
                ...
                'value': [-.15, TOP_TRACK_LWHT[1]/2+.01, .3+(random.uniform(-.1,.1)), 0, 0, 0]
            }
        },
        {
            'name': "occluder",
            ...
            'xform': {
                'value': [.18, .1, OCCLUDER_LWH[0]/2-.01, 0, 0, 90],
            }
        },
        movingObject
    ]
